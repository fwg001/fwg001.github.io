...
<style>
  ...
  .config-recap-post .topic-link { font-family: "Space Mono", monospace; font-size: 11px; letter-spacing: 0.15em; text-transform: uppercase; color: #8bbcff; text-decoration: underline; align-self: fle[...] 
  ...
  @media (max-width: 900px) {
    .config-recap-post header, .config-recap-post .intro-strip, .config-recap-post .section-headline, .config-recap-post .photo-section, .config-recap-post .notes-section, .config-recap-post foot[...] 
...
<div class="photo-section">
  <div class="photo-layout">
    ...
    <div class="photo-text">
      ...
      <div class="note-body">Since the start, Congif has grown like crazy each year at Moscone Center in San Francicisco. Each time I return the Figma team has put so much work into building a un[...]
    </div>
    <div class="photo-text">
...
<div class="photo-section">
  <div class="photo-layout reverse">
    ...
    <div class="photo-text">
      ...
      <div class="note-body">My new favorite way to start a tech conference - escape tech and explore nature instead! <a href="https://www.linkedin.com/in/bencallahan/">Ben Callahan</a> organized[...]
    </div>
  </div>
</div>
...
<div class="notes-section">
  <div class="note-card">
    ...
    <div class="note-body">I loved this talk by <a href="https://www.linkedin.com/in/laurenloprete/">Lauren LoPrete</a>. It told a great story using punk music venues to teach principles for fost[...]
      <ul>
        ...
        <li>Design systems work has drifted into compliance work — teams meant to lower barriers and raise quality have started acting like gatekeepers, adding stricter standards, more approval[...]
        <li>AI tools are democratizing production the way the Xerox machine did for punk zines and flyers — when the means of production become this accessible, the scene grows, and you can’t[...]
        <li>Her framework — “design systems anarchy”: modeled on how punk scenes built infrastructure for creative chaos instead of containing it; the venues that lasted had the clearest va[...]
  ...
  <div class="note-card">
    ...
    <div class="note-body"><a href="https://www.linkedin.com/in/benkshown/">Ben Shown</a> and <a href="https://www.linkedin.com/in/megan-greco-7328774a/">Megan Greco</a> got to design with the fu[...]
      <ul>
        <li>NASA’s redesign succeeded because it grounded decisions in <b>audience motivations</b>, not just demographics, using an alternative to personas, they called “Thinking Styles”, t[...]
        <li>The team used a research-led, low-fi-first process: large-scale survey work, in-depth interviews, rough concept exploration, and repeated stakeholder critique to get better strategic ...
        <li>Outcome was not just a visual refresh but a scalable system: Horizon gave NASA a consistent design foundation across thousands of sites and supported products like NASA.gov, NASA+, an[...]
      </ul>
